...
class TeamService(
  ...
  suspend fun getCaseTierTotals(staffCode: String, teamCode: String): TierCaseTotals? {
    ...
    else return TierCaseTotals(BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO)
  }
}
