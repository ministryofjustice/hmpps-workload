...
data class LicenseTierPoints(
  ...
  @Column(name = "lic_tier_2")
  val A2Points: BigInteger,
  @Column(name = "lic_tier_3")
  val A1Points: BigInteger,
  @Column(name = "lic_tier_4")
  val A0Points: BigInteger,
  @Column(name = "lic_tier_5")
  val B3Points: BigInteger,
  @Column(name = "lic_tier_6")
  val B2Points: BigInteger,
  @Column(name = "lic_tier_7")
  val B1Points: BigInteger,
  @Column(name = "lic_tier_8")
  val B0Points: BigInteger,
  @Column(name = "lic_tier_9")
  val C3Points: BigInteger,
  @Column(name = "lic_tier_10")
  val C2Points: BigInteger,
  @Column(name = "lic_tier_11")
  val C1Points: BigInteger,
  @Column(name = "lic_tier_12")
  val C0Points: BigInteger,
  @Column(name = "lic_tier_13")
  val D3Points: BigInteger,
  @Column(name = "lic_tier_14")
  val D2Points: BigInteger,
  @Column(name = "lic_tier_15")
  val D1Points: BigInteger,
  @Column(name = "lic_tier_16")
  val D0Points: BigInteger,
  @Column(name = "lic_tier_1_s")
  val A3SPoints: BigInteger,
  @Column(name = "lic_tier_2_s")
  val A2SPoints: BigInteger,
  @Column(name = "lic_tier_3_s")
  val A1SPoints: BigInteger,
  @Column(name = "lic_tier_4_s")
  val A0SPoints: BigInteger,
  @Column(name = "lic_tier_5_s")
  val B3SPoints: BigInteger,
  @Column(name = "lic_tier_6_s")
  val B2SPoints: BigInteger,
  @Column(name = "lic_tier_7_s")
  val B1SPoints: BigInteger,
  @Column(name = "lic_tier_8_s")
  val B0SPoints: BigInteger,
  @Column(name = "lic_tier_9_s")
  val C3SPoints: BigInteger,
  @Column(name = "lic_tier_10_s")
  val C2SPoints: BigInteger,
  @Column(name = "lic_tier_11_s")
  val C1SPoints: BigInteger,
  @Column(name = "lic_tier_12_s")
  val C0SPoints: BigInteger,
  @Column(name = "lic_tier_13_s")
  val D3SPoints: BigInteger,
  @Column(name = "lic_tier_14_s")
  val D2SPoints: BigInteger,
  @Column(name = "lic_tier_15_s")
  val D1SPoints: BigInteger,
  @Column(name = "lic_tier_16_s")
